...
Future<void> sendUserData(Map<String, String> userData) async {
  var url = 'https://8317-2804-14c-51-a70d-a54c-8de8-1d9d-5ae4.ngrok-free.app'; // Altere para a URL correta de registro de usuário no seu servidor
...
Future<void> sendOrganizationData(Map<String, String> organizationData) async {
  var url = 'https://8317-2804-14c-51-a70d-a54c-8de8-1d9d-5ae4.ngrok-free.app'; // Altere para a URL correta de registro de organização no seu servidor
  var headers = {'Content-Type': 'application/json'};
...
Future<bool> loginUsuario(String cpf, String senhaU) async {
  var url = 'https://8317-2804-14c-51-a70d-a54c-8de8-1d9d-5ae4.ngrok-free.app'; // Altere para a URL correta de login de usuário no seu servidor
  var headers = {'Content-Type': 'application/json'};
...
Future<bool> loginOrganizacao(String cnpj, String senha) async {
  var url = 'https://8317-2804-14c-51-a70d-a54c-8de8-1d9d-5ae4.ngrok-free.app'; // Altere para a URL correta de login de organização no seu servidor
  var headers = {'Content-Type': 'application/json'};
...
Future<bool> enviarAgendamento(TimeOfDay _horarioSelecionado, DateTime _diaSelecionado) async {
  var url = 'https://8317-2804-14c-51-a70d-a54c-8de8-1d9d-5ae4.ngrok-free.app';
  var headers = {'Content-Type': 'application/json'};
...
Future<void> fetchRecentAgendamentos(Function(List<Map<String, dynamic>>) callback) async {
  try {
    final url = 'https://8317-2804-14c-51-a70d-a54c-8de8-1d9d-5ae4.ngrok-free.app';
